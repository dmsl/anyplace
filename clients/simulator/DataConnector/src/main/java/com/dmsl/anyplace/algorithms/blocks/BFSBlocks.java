...
public class BFSBlocks extends AlgorithmBlocks {
	...
	public static void main(String[] args) throws Exception {
		...
		BFSBlocks b = new BFSBlocks(building.getVertices(), 3, new Random(),
				0.25f);
	...
	public BFSBlocks(CleanPoi[] vertices, int nBlocks, Random rnd,
					 float probLost) {
